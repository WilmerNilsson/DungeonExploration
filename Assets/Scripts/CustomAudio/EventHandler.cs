...
namespace CustomAudio
{
    public static class EventHandler
    {
        ...
        #region Lookup
        public static Dictionary<string, EventList> EventListLookup = new Dictionary<string, EventList>();
        
        private static bool TryGetEventData(string path, out EventData eventData, out EventList eventList)
        {
        ...
        private static bool HasEventLoaded(EventData eventData)
        {
            var hasLoaded = true;
        ...
        public static void CreateInstance(string eventName, GameObject gameObject = null, bool followObject = true)
        {
        ...
        public static void LoadSampleData(string eventName)
        {
        ...
        public static void ReleaseInstance(string eventName, GameObject gameObject = null) //Som CreateInstance fast släpper instansen istället
        {
           if (!TryGetEventData(eventName, out var eventData, out var list)) return;
        ...
        public static void UnloadSampleData(string eventName)
        {
           if (!TryGetEventData(eventName, out var eventData, out _)) return;
            if (eventData.isOneShot)
            {
        ...
        public static void StartEvent(string eventName, GameObject gameObject = null) //Som CreateInstance fast startar instansen istället OM instansen inte redan spelar
        {
        ...
        public static void StopEvent(string eventName, STOP_MODE stopMode, GameObject gameObject = null) //Som CreateInstance fast stoppar med stopMode, denna bör kallas innan releaseInstance
        {
            if (TryGetEventData(eventName, out var eventData, out var list))
            {
                if (gameObject != null)
        ...
        public static void SetParameter(string eventName, string paramName, float paramValue, GameObject gameObject = null) //Som CreateInstance men sätter parametrar. Om en parameter är global behöver man inte köra setParameter på instansen utan bara i studioSystem.
        {
           if (!TryGetEventData(eventName, out var eventData, out var list)) return;
        ...
        public static void KeyOff(string eventName, GameObject gameObject = null) //Som CreateInstance men skickar KeyOff
        {
           if (!TryGetEventData(eventName, out var eventData, out var list)) return;
        ...
        public static void PlayOneShot(string eventName, string[] paramNames = null, float[] paramValues = null,GameObject gameObject = null, bool followObject = true)
        {
        ...
        public static void InitializeDialogue(string path)
        {
        ...
        public static void SayLine(string eventName, string lineParameter, int lineIndex)
        {
           if (!TryGetEventData(eventName, out var eventData, out _)) return; 
            if (!eventData.EventInstance.isValid())
            {
        ...
        public static void StopLine(string eventName) //Stoppa instansen om event finns
        {
           if (!TryGetEventData(eventName, out var eventData, out _)) return;
            eventData.EventInstance.stop(STOP_MODE.ALLOWFADEOUT);
        }

        public static void EndDialogue(string eventName) //Stoppa och släpp instans
        {
           if (!TryGetEventData(eventName, out var eventData, out _)) return;
            eventData.EventInstance.stop(STOP_MODE.ALLOWFADEOUT);
            eventData.EventInstance.release();
            ...
            public static void PauseAllSfx(bool paused)
            {
                if (!BankHandler.BankLookup.TryGetValue("Master", out var bank)) return;
